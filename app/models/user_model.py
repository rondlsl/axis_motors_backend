...
class User(Base):
    ...
    # Deliverability: pending | verified | bounced | complaint | suppressed (see email reputation system)
    email_status = Column(String(20), nullable=True, server_default=text("'pending'"))
