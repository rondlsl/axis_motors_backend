"""
Router для работы с завершёнными арендами для бухгалтеров
"""
...
accountant_rentals_router = APIRouter(tags=["Accountant Rentals"])
...
@accountant_rentals_router.get("/completed", summary="Получить все завершённые аренды")
async def get_completed_rentals(
    ...
    """
    Возвращает все завершённые аренды с полной информацией для бухгалтера:
    - Информация о машине
