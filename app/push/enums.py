...
class NotificationStatus(str, Enum):
    ...
    HOLIDAY_GREETING = "holiday_greeting"  # Поздравления с праздниками (устаревший, для совместимости)
    NEW_YEAR = "new_year"  # Новый год (1-2 января)
    CHRISTMAS = "christmas"  # Рождество (7 января)
    WOMENS_DAY = "womens_day"  # Международный женский день (8 марта)
    NAURYZ = "nauryz"  # Наурыз (21-23 марта)
    UNITY_DAY = "unity_day"  # День единства народа Казахстана (1 мая)
    DEFENDER_DAY = "defender_day"  # День защитника Отечества (7 мая)
    VICTORY_DAY = "victory_day"  # День Победы (9 мая)
    CAPITAL_DAY = "capital_day"  # День столицы (6 июля)
    CONSTITUTION_DAY = "constitution_day"  # День Конституции (30 августа)
    REPUBLIC_DAY = "republic_day"  # День Республики (25 октября)
    INDEPENDENCE_DAY = "independence_day"  # День Независимости (16-17 декабря)
