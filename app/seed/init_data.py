...
def create_cars(db: Session, owner: User) -> None:
    ...
    specs = [
        ...
        },
        {
            ...
            "auto_class": CarAutoClass.A,
            "course": 0,
            "description": "Описание авто: 1) Скол и потертость на левом боковом зеркале 2) Потертость на правом боковом зеркале 3) Сколы на всех 4 дисках 4) Справа на багажнике и заднем бампере скол длиной в 5см 5) Скол на черном молдинге водительской двери. Комплект авто: 1) Запаска 2) Полный комплект домкрата 3) Аптечка 4) Крюк буксировки 5) Трос",
