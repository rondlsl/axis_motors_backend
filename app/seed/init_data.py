...
def create_cars(db: Session, owner: User) -> None:
    ...
    specs = [
        ...
        },
        {
            ...
            "auto_class": CarAutoClass.B,
            "course": 0,
            "description": "1) Маленькая притертость на заднем бампере справа,около колеса. 2) Нет парктроника на переднем бампере 3) Слева царапина на левой передней двери слева снизу от ручки двери. Комплект авто: 1) Кожаный паралон мазерати(черная палка) 2) два парктроника 3) домкрат 4) буксировочный крюк 5) белая воронка для бензина 6) шестигранник 7) отвертка(звездочка) 8) красная отвертка с Головкой",
        ...
        },
        {
            "name": "Mercedes W222",
            "gps_id": "800412252",
            "gps_imei": "860803068133152",
            "engine_volume": 4.0,
            "year": 2017,
            "drive_type": 3,
            "transmission_type": "automatic",
            "price_per_minute": 295,
            "price_per_hour": 11700,
            "price_per_day": 120000,
            "plate_number": "109BPU02",
            "latitude": 43.224048,
            "longitude": 76.961871,
            "fuel_level": 65,
            "body_type": CarBodyType.SEDAN,
            "auto_class": CarAutoClass.B,
            "course": 23,
            "description": "1) глубокая царапина задняя левая дверь \n2) царапина левая передняя дверь \n3) передняя нижняя губа с левой стороны повреждение \n4) шорки на правой передней двери \n5) повреждения на ребре задней правой двери( место когда дверь открываешь и задеваешь) \n6) скол на лобовом стекле \n7) левый задний, левый передний, правый задний диск повреждены\n\nКомплект авто:\nКрасный насос \nКрасный трос",
            "photos": get_car_photos("109BPU02"),
            "vin": "WDDUG8GB2JA383508",
            "color": "Черный",
        },
        {
        ...
        },
        {
            ...
            "auto_class": CarAutoClass.A,
            "course": 0,
            "description": "Повреждения: 1) левый передний диск небольшая коцка 2) левый задний диск небольшая коцка 3) задний бампер с левой стороны царапина 4) задний правый диск небольшая коцка 5) правый передний диск поврежден 6) сколы на основной длиной фаре 7) поцарапано все лобовое стекло. Наличие: 1) щетка для снега синяя 2) аптечка сумка красная 3) огнетушитель красный 4) крюк для буксировки 5) аварийный знак красная коробка 6) компрессор для шин 7) желтый жилет 8) запасное колесо",
            "photos": get_car_photos("737BDG02"),
            "vin": "HLX33B123R1672765",
            "color": "Серый",
        },
        {
            "name": "Lexus GX460",
            "gps_id": "800413326",
            "gps_imei": "860803068155965",
            "engine_volume": 4.6,
            "year": 2021,
            "drive_type": 3,
            "transmission_type": "automatic",
            "price_per_minute": 280,
            "price_per_hour": 13500,
            "price_per_day": 220000,
            "plate_number": "621BRO02",
            "latitude": 43.224048,
            "longitude": 76.961871,
            "fuel_level": 50,
            "body_type": CarBodyType.SUV,
            "auto_class": CarAutoClass.A,
            "course": 0,
            "description": "Премиальный внедорожник Lexus GX460. Комплект: 1) Запасное колесо 2) Домкрат 3) Аптечка 4) Крюк для буксировки 5) Огнетушитель 6) Аварийный знак",
            "photos": get_car_photos("621BRO02"),
