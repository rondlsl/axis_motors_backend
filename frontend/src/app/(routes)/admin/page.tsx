...
export default function AdminMap() {
  const { isLoaded } = useLoadScript({ googleMapsApiKey: "AIzaSyB9EVkg41dDQ-Uom21F3adndnFWAeiEEIM" })
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-20 bg-white shadow-md p-3 flex justify-center gap-4 md:absolute md:top-4 md:left-4 md:right-auto">
      ...
      {selectedCar && (
        <div className="fixed bottom-0 left-0 right-0 md:left-1/2 md:transform md:-translate-x-1/2 w-full md:w-96 p-4 bg-white shadow-lg rounded-t-lg z-20 border-t-4 border-blue-500">
