...
Revision ID: 66d7254eaea4
Revises: 
Create Date: 2025-04-08 16:26:50.813106
...
def upgrade() -> None:
    ...
    sa.Column('rental_status', sa.Enum('RESERVED', 'IN_USE', 'COMPLETED', name='rentalstatus'), nullable=False),
