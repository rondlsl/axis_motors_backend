...
Revision ID: 6a3bfce1868c
Revises: 
Create Date: 2025-01-04 15:35:27.587068
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'USER', 'REJECTED', 'FIRST', 'PENDING', name='userrole'), nullable=True),
